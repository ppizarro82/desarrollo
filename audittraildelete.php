...
<?php if ($audittrail->table->Visible) { // table ?>
		<th class="<?php echo $audittrail->table->HeaderCellClass() ?>"><span id="elh_audittrail_table" class="audittrail_table"><?php echo $audittrail->table->FldCaption() ?></span></th>
<?php } ?>
<?php if ($audittrail->field->Visible) { // field ?>
		<th class="<?php echo $audittrail->field->HeaderCellClass() ?>"><span id="elh_audittrail_field" class="audittrail_field"><?php echo $audittrail->field->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_table" class="audittrail_table">
<span<?php echo $audittrail->table->ViewAttributes() ?>>
<?php echo $audittrail->table->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($audittrail->field->Visible) { // field ?>
...
<?php echo $audittrail->field->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
