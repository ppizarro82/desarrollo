	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("userlevelpermissionslist.php"); // Return to list
			}
		}
	}
...
fuserlevelpermissionsdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
		<th class="<?php echo $userlevelpermissions->userlevelid->HeaderCellClass() ?>"><span id="elh_userlevelpermissions_userlevelid" class="userlevelpermissions_userlevelid"><?php echo $userlevelpermissions->userlevelid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($userlevelpermissions->_tablename->Visible) { // tablename ?>
		<th class="<?php echo $userlevelpermissions->_tablename->HeaderCellClass() ?>"><span id="elh_userlevelpermissions__tablename" class="userlevelpermissions__tablename"><?php echo $userlevelpermissions->_tablename->FldCaption() ?></span></th>
<?php } ?>
<?php if ($userlevelpermissions->permission->Visible) { // permission ?>
		<th class="<?php echo $userlevelpermissions->permission->HeaderCellClass() ?>"><span id="elh_userlevelpermissions_permission" class="userlevelpermissions_permission"><?php echo $userlevelpermissions->permission->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
