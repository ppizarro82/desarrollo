...
class caudittrail extends cTable {
	...
	function __construct() {
		...
		// newvalue
		$this->newvalue = new cField('audittrail', 'audittrail', 'x_newvalue', 'newvalue', '`newvalue`', '`newvalue`', 201, -1, FALSE, '`newvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->newvalue->Sortable = TRUE; // Allow sort
		$this->newvalue->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->newvalue->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->newvalue->OptionCount = 3;
	...
	function RenderEditRow() {
		...
		$this->newvalue->EditValue = $this->newvalue->Options(TRUE);
