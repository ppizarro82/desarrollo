...
class caudittrail_edit extends caudittrail {
	...
	function LoadRowValues($rs = NULL) {
		...
		$this->table->setDbValue($row['table']);
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// table
			$this->table->SetDbValueDef($rsnew, $this->table->CurrentValue, NULL, $this->table->ReadOnly);
...
faudittrailedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($audittrail_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($audittrail->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_audittrail_id" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->id->FldCaption() ?></label>
...
<?php if ($audittrail->datetime->Visible) { // datetime ?>
	<div id="r_datetime" class="form-group">
		<label id="elh_audittrail_datetime" for="x_datetime" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->datetime->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($audittrail->script->Visible) { // script ?>
	<div id="r_script" class="form-group">
		<label id="elh_audittrail_script" for="x_script" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->script->FldCaption() ?></label>
...
<?php if ($audittrail->user->Visible) { // user ?>
	<div id="r_user" class="form-group">
		<label id="elh_audittrail_user" for="x_user" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->user->FldCaption() ?></label>
...
<?php if ($audittrail->action->Visible) { // action ?>
	<div id="r_action" class="form-group">
		<label id="elh_audittrail_action" for="x_action" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->action->FldCaption() ?></label>
		<div class="<?php echo $audittrail_edit->RightColumnClass ?>"><div<?php echo $audittrail->action->CellAttributes() ?>>
...
<?php if ($audittrail->table->Visible) { // table ?>
	<div id="r_table" class="form-group">
		<label id="elh_audittrail_table" for="x_table" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->table->FldCaption() ?></label>
		<div class="<?php echo $audittrail_edit->RightColumnClass ?>"><div<?php echo $audittrail->table->CellAttributes() ?>>
<span id="el_audittrail_table">
<input type="text" data-table="audittrail" data-field="x_table" name="x_table" id="x_table" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($audittrail->table->getPlaceHolder()) ?>" value="<?php echo $audittrail->table->EditValue ?>"<?php echo $audittrail->table->EditAttributes() ?>>
</span>
<?php echo $audittrail->table->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($audittrail->field->Visible) { // field ?>
	<div id="r_field" class="form-group">
		<label id="elh_audittrail_field" for="x_field" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->field->FldCaption() ?></label>
...
<input type="text" data-table="audittrail" data-field="x_field" name="x_field" id="x_field" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($audittrail->field->getPlaceHolder()) ?>" value="<?php echo $audittrail->field->EditValue ?>"<?php echo $audittrail->field->EditAttributes() ?>>
</span>
...
<?php if ($audittrail->keyvalue->Visible) { // keyvalue ?>
	<div id="r_keyvalue" class="form-group">
		<label id="elh_audittrail_keyvalue" for="x_keyvalue" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->keyvalue->FldCaption() ?></label>
...
<?php if ($audittrail->oldvalue->Visible) { // oldvalue ?>
	<div id="r_oldvalue" class="form-group">
		<label id="elh_audittrail_oldvalue" for="x_oldvalue" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->oldvalue->FldCaption() ?></label>
...
<?php if ($audittrail->newvalue->Visible) { // newvalue ?>
	<div id="r_newvalue" class="form-group">
		<label id="elh_audittrail_newvalue" for="x_newvalue" class="<?php echo $audittrail_edit->LeftColumnClass ?>"><?php echo $audittrail->newvalue->FldCaption() ?></label>
