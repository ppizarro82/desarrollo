...
fvehiculosadd.Lists["x_id_persona"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_paterno","x_materno","x_nombres",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
fvehiculosadd.Lists["x_id_persona"].Data = "<?php echo $vehiculos_add->id_persona->LookupFilterQuery(FALSE, "add") ?>";
fvehiculosadd.Lists["x_id_fuente"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"fuentes"};
fvehiculosadd.Lists["x_id_fuente"].Data = "<?php echo $vehiculos_add->id_fuente->LookupFilterQuery(FALSE, "add") ?>";
fvehiculosadd.Lists["x_id_gestion"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gestiones"};
fvehiculosadd.Lists["x_id_gestion"].Data = "<?php echo $vehiculos_add->id_gestion->LookupFilterQuery(FALSE, "add") ?>";
...
<?php if ($vehiculos->id_fuente->Visible) { // id_fuente ?>
	<div id="r_id_fuente" class="form-group">
		<label id="elh_vehiculos_id_fuente" for="x_id_fuente" class="<?php echo $vehiculos_add->LeftColumnClass ?>"><?php echo $vehiculos->id_fuente->FldCaption() ?></label>
		<div class="<?php echo $vehiculos_add->RightColumnClass ?>"><div<?php echo $vehiculos->id_fuente->CellAttributes() ?>>
...
<?php if ($vehiculos->id_gestion->Visible) { // id_gestion ?>
	<div id="r_id_gestion" class="form-group">
		<label id="elh_vehiculos_id_gestion" for="x_id_gestion" class="<?php echo $vehiculos_add->LeftColumnClass ?>"><?php echo $vehiculos->id_gestion->FldCaption() ?></label>
		<div class="<?php echo $vehiculos_add->RightColumnClass ?>"><div<?php echo $vehiculos->id_gestion->CellAttributes() ?>>
