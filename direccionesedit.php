...
class cdirecciones_edit extends cdirecciones {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// id_tipodireccion
			$this->id_tipodireccion->SetDbValueDef($rsnew, $this->id_tipodireccion->CurrentValue, 0, $this->id_tipodireccion->ReadOnly);
			...
			// direccion1
			$this->direccion1->SetDbValueDef($rsnew, $this->direccion1->CurrentValue, "", $this->direccion1->ReadOnly);

			// direccion2
			$this->direccion2->SetDbValueDef($rsnew, $this->direccion2->CurrentValue, NULL, $this->direccion2->ReadOnly);

			// direccion3
			$this->direccion3->SetDbValueDef($rsnew, $this->direccion3->CurrentValue, NULL, $this->direccion3->ReadOnly);

			// direccion4
			$this->direccion4->SetDbValueDef($rsnew, $this->direccion4->CurrentValue, NULL, $this->direccion4->ReadOnly);
...
fdireccionesedit.Lists["x_id_fuente"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"fuentes"};
fdireccionesedit.Lists["x_id_fuente"].Data = "<?php echo $direcciones_edit->id_fuente->LookupFilterQuery(FALSE, "edit") ?>";
fdireccionesedit.Lists["x_id_gestion"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gestiones"};
fdireccionesedit.Lists["x_id_gestion"].Data = "<?php echo $direcciones_edit->id_gestion->LookupFilterQuery(FALSE, "edit") ?>";
fdireccionesedit.Lists["x_id_tipodireccion"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipo_direccion"};
fdireccionesedit.Lists["x_id_tipodireccion"].Data = "<?php echo $direcciones_edit->id_tipodireccion->LookupFilterQuery(FALSE, "edit") ?>";
...
<div class="nav-tabs-custom" id="direcciones_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $direcciones_edit->MultiPages->NavStyle() ?>">
		...
		<li<?php echo $direcciones_edit->MultiPages->TabStyle("3") ?>><a href="#tab_direcciones3" data-toggle="tab"><?php echo $direcciones->PageCaption(3) ?></a></li>
		<li<?php echo $direcciones_edit->MultiPages->TabStyle("4") ?>><a href="#tab_direcciones4" data-toggle="tab"><?php echo $direcciones->PageCaption(4) ?></a></li>
	</ul>
...
<?php if ($direcciones->id_fuente->Visible) { // id_fuente ?>
	<div id="r_id_fuente" class="form-group">
		<label id="elh_direcciones_id_fuente" for="x_id_fuente" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->id_fuente->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->id_fuente->CellAttributes() ?>>
...
<?php if ($direcciones->id_gestion->Visible) { // id_gestion ?>
	<div id="r_id_gestion" class="form-group">
		<label id="elh_direcciones_id_gestion" for="x_id_gestion" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->id_gestion->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->id_gestion->CellAttributes() ?>>
...
<?php if ($direcciones->id_tipodireccion->Visible) { // id_tipodireccion ?>
	<div id="r_id_tipodireccion" class="form-group">
		<label id="elh_direcciones_id_tipodireccion" for="x_id_tipodireccion" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->id_tipodireccion->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->id_tipodireccion->CellAttributes() ?>>
...
<?php if ($direcciones->tipo_documento->Visible) { // tipo_documento ?>
	<div id="r_tipo_documento" class="form-group">
		<label id="elh_direcciones_tipo_documento" for="x_tipo_documento" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->tipo_documento->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->tipo_documento->CellAttributes() ?>>
...
<?php if ($direcciones->no_documento->Visible) { // no_documento ?>
	<div id="r_no_documento" class="form-group">
		<label id="elh_direcciones_no_documento" for="x_no_documento" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->no_documento->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->no_documento->CellAttributes() ?>>
...
<?php if ($direcciones->nombres->Visible) { // nombres ?>
	<div id="r_nombres" class="form-group">
		<label id="elh_direcciones_nombres" for="x_nombres" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->nombres->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->nombres->CellAttributes() ?>>
...
<?php if ($direcciones->paterno->Visible) { // paterno ?>
	<div id="r_paterno" class="form-group">
		<label id="elh_direcciones_paterno" for="x_paterno" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->paterno->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->paterno->CellAttributes() ?>>
...
<?php if ($direcciones->materno->Visible) { // materno ?>
	<div id="r_materno" class="form-group">
		<label id="elh_direcciones_materno" for="x_materno" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->materno->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->materno->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $direcciones_edit->MultiPages->PageStyle("3") ?>" id="tab_direcciones3"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($direcciones->pais->Visible) { // pais ?>
	<div id="r_pais" class="form-group">
		<label id="elh_direcciones_pais" for="x_pais" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->pais->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->pais->CellAttributes() ?>>
...
<?php if ($direcciones->departamento->Visible) { // departamento ?>
	<div id="r_departamento" class="form-group">
		<label id="elh_direcciones_departamento" for="x_departamento" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->departamento->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->departamento->CellAttributes() ?>>
...
<?php if ($direcciones->provincia->Visible) { // provincia ?>
	<div id="r_provincia" class="form-group">
		<label id="elh_direcciones_provincia" for="x_provincia" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->provincia->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->provincia->CellAttributes() ?>>
...
<?php if ($direcciones->municipio->Visible) { // municipio ?>
	<div id="r_municipio" class="form-group">
		<label id="elh_direcciones_municipio" for="x_municipio" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->municipio->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->municipio->CellAttributes() ?>>
...
<?php if ($direcciones->localidad->Visible) { // localidad ?>
	<div id="r_localidad" class="form-group">
		<label id="elh_direcciones_localidad" for="x_localidad" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->localidad->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->localidad->CellAttributes() ?>>
...
<?php if ($direcciones->distrito->Visible) { // distrito ?>
	<div id="r_distrito" class="form-group">
		<label id="elh_direcciones_distrito" for="x_distrito" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->distrito->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->distrito->CellAttributes() ?>>
...
<?php if ($direcciones->zona->Visible) { // zona ?>
	<div id="r_zona" class="form-group">
		<label id="elh_direcciones_zona" for="x_zona" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->zona->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->zona->CellAttributes() ?>>
...
<?php if ($direcciones->direccion1->Visible) { // direccion1 ?>
	<div id="r_direccion1" class="form-group">
		<label id="elh_direcciones_direccion1" for="x_direccion1" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->direccion1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->direccion1->CellAttributes() ?>>
...
<?php if ($direcciones->direccion2->Visible) { // direccion2 ?>
	<div id="r_direccion2" class="form-group">
		<label id="elh_direcciones_direccion2" for="x_direccion2" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->direccion2->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->direccion2->CellAttributes() ?>>
...
<?php if ($direcciones->direccion3->Visible) { // direccion3 ?>
	<div id="r_direccion3" class="form-group">
		<label id="elh_direcciones_direccion3" for="x_direccion3" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->direccion3->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->direccion3->CellAttributes() ?>>
...
<?php if ($direcciones->direccion4->Visible) { // direccion4 ?>
	<div id="r_direccion4" class="form-group">
		<label id="elh_direcciones_direccion4" for="x_direccion4" class="<?php echo $direcciones_edit->LeftColumnClass ?>"><?php echo $direcciones->direccion4->FldCaption() ?></label>
		<div class="<?php echo $direcciones_edit->RightColumnClass ?>"><div<?php echo $direcciones->direccion4->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $direcciones_edit->MultiPages->PageStyle("4") ?>" id="tab_direcciones4"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
...
function initMap(x = 0) {
	...
	var zoom = 6;
		if (x == 0)
		{
			if(document.getElementById('x_latitud').value != "" & document.getElementById('x_longitud').value != "")
			{
