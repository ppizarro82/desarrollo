	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Id"] <> "") {
				...
				$sReturnUrl = "vehiculoslist.php"; // Return to list
			}
...
var CurrentForm = fvehiculosview = new ew_Form("fvehiculosview", "view");
...
<input type="hidden" name="modal" value="<?php echo intval($vehiculos_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($vehiculos->Id->Visible) { // Id ?>
	<tr id="r_Id">
		<td class="col-sm-2"><span id="elh_vehiculos_Id"><?php echo $vehiculos->Id->FldCaption() ?></span></td>
		<td data-name="Id"<?php echo $vehiculos->Id->CellAttributes() ?>>
<span id="el_vehiculos_Id">
<span<?php echo $vehiculos->Id->ViewAttributes() ?>>
<?php echo $vehiculos->Id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vehiculos->id_persona->Visible) { // id_persona ?>
	<tr id="r_id_persona">
		<td class="col-sm-2"><span id="elh_vehiculos_id_persona"><?php echo $vehiculos->id_persona->FldCaption() ?></span></td>
...
<a<?php echo $vehiculos->id_persona->LinkAttributes() ?>><?php echo $vehiculos->id_persona->ViewValue ?></a>
<?php } else { ?>
...
<?php if ($vehiculos->marca->Visible) { // marca ?>
	<tr id="r_marca">
		<td class="col-sm-2"><span id="elh_vehiculos_marca"><?php echo $vehiculos->marca->FldCaption() ?></span></td>
...
<?php echo $vehiculos->marca->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vehiculos->modelo->Visible) { // modelo ?>
	<tr id="r_modelo">
		<td class="col-sm-2"><span id="elh_vehiculos_modelo"><?php echo $vehiculos->modelo->FldCaption() ?></span></td>
...
<?php if ($vehiculos->placa->Visible) { // placa ?>
	<tr id="r_placa">
		<td class="col-sm-2"><span id="elh_vehiculos_placa"><?php echo $vehiculos->placa->FldCaption() ?></span></td>
...
<?php echo $vehiculos->placa->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vehiculos->anio->Visible) { // anio ?>
	<tr id="r_anio">
		<td class="col-sm-2"><span id="elh_vehiculos_anio"><?php echo $vehiculos->anio->FldCaption() ?></span></td>
...
<?php echo $vehiculos->anio->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
