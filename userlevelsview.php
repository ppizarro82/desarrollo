...
fuserlevelsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($userlevels_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($userlevels->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid">
		<td class="col-sm-2"><span id="elh_userlevels_userlevelid"><?php echo $userlevels->userlevelid->FldCaption() ?></span></td>
...
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
	<tr id="r_userlevelname">
		<td class="col-sm-2"><span id="elh_userlevels_userlevelname"><?php echo $userlevels->userlevelname->FldCaption() ?></span></td>
