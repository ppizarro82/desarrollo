...
class cemails extends cTable {
	...
	function __construct() {
		...
		// Id
		$this->Id = new cField('emails', 'emails', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`emails`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "emailsedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "emailsadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("emailsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("emailsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "emailsadd.php?" . $this->UrlParm($parm);
		else
			$url = "emailsadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("emailsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("emailsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("emailsdelete.php", $this->UrlParm());
	}
