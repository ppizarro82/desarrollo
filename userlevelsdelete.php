...
fuserlevelsdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($userlevels->userlevelid->Visible) { // userlevelid ?>
		<th class="<?php echo $userlevels->userlevelid->HeaderCellClass() ?>"><span id="elh_userlevels_userlevelid" class="userlevels_userlevelid"><?php echo $userlevels->userlevelid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
		<th class="<?php echo $userlevels->userlevelname->HeaderCellClass() ?>"><span id="elh_userlevels_userlevelname" class="userlevels_userlevelname"><?php echo $userlevels->userlevelname->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
