...
class cuserlevelpermissions_list extends cuserlevelpermissions {
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = isset($UserProfile) ? $UserProfile->GetSearchFilters(CurrentUserName(), "fuserlevelpermissionslistsrch") : "";
		} else {
			$sSavedFilterList = "";
		}
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.fuserlevelpermissionslist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->CanDelete());
...
fuserlevelpermissionslist.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php
	...
	if ($bSelectLimit) {
		if ($userlevelpermissions_list->TotalRecs <= 0)
			$userlevelpermissions_list->TotalRecs = $userlevelpermissions->ListRecordCount();
	} else {
	...
	if ($userlevelpermissions->CurrentAction == "" && $userlevelpermissions_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$userlevelpermissions_list->setWarningMessage(ew_DeniedMsg());
...
<div class="box ewBox ewGrid<?php if ($userlevelpermissions_list->IsAddOrEdit()) { ?> ewGridAddEdit<?php } ?> userlevelpermissions">
<?php if ($userlevelpermissions->Export == "") { ?>
<div class="box-header ewGridUpperPanel">
<?php if ($userlevelpermissions->CurrentAction <> "gridadd" && $userlevelpermissions->CurrentAction <> "gridedit") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($userlevelpermissions_list->Pager)) $userlevelpermissions_list->Pager = new cPrevNextPager($userlevelpermissions_list->StartRec, $userlevelpermissions_list->DisplayRecs, $userlevelpermissions_list->TotalRecs, $userlevelpermissions_list->AutoHidePager) ?>
...
<?php } ?>
<input type="hidden" name="t" value="userlevelpermissions">
<div id="gmp_userlevelpermissions" class="<?php if (ew_IsResponsiveLayout()) { ?>table-responsive <?php } ?>ewGridMiddlePanel">
<?php if ($userlevelpermissions_list->TotalRecs > 0 || $userlevelpermissions->CurrentAction == "gridedit") { ?>
...
<?php if ($userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	<?php if ($userlevelpermissions->SortUrl($userlevelpermissions->userlevelid) == "") { ?>
		<th data-name="userlevelid" class="<?php echo $userlevelpermissions->userlevelid->HeaderCellClass() ?>"><div id="elh_userlevelpermissions_userlevelid" class="userlevelpermissions_userlevelid"><div class="ewTableHeaderCaption"><?php echo $userlevelpermissions->userlevelid->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="userlevelid" class="<?php echo $userlevelpermissions->userlevelid->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevelpermissions->SortUrl($userlevelpermissions->userlevelid) ?>',1);"><div id="elh_userlevelpermissions_userlevelid" class="userlevelpermissions_userlevelid">
...
<?php if ($userlevelpermissions->_tablename->Visible) { // tablename ?>
	<?php if ($userlevelpermissions->SortUrl($userlevelpermissions->_tablename) == "") { ?>
		<th data-name="_tablename" class="<?php echo $userlevelpermissions->_tablename->HeaderCellClass() ?>"><div id="elh_userlevelpermissions__tablename" class="userlevelpermissions__tablename"><div class="ewTableHeaderCaption"><?php echo $userlevelpermissions->_tablename->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_tablename" class="<?php echo $userlevelpermissions->_tablename->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevelpermissions->SortUrl($userlevelpermissions->_tablename) ?>',1);"><div id="elh_userlevelpermissions__tablename" class="userlevelpermissions__tablename">
...
<?php if ($userlevelpermissions->permission->Visible) { // permission ?>
	<?php if ($userlevelpermissions->SortUrl($userlevelpermissions->permission) == "") { ?>
		<th data-name="permission" class="<?php echo $userlevelpermissions->permission->HeaderCellClass() ?>"><div id="elh_userlevelpermissions_permission" class="userlevelpermissions_permission"><div class="ewTableHeaderCaption"><?php echo $userlevelpermissions->permission->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="permission" class="<?php echo $userlevelpermissions->permission->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevelpermissions->SortUrl($userlevelpermissions->permission) ?>',1);"><div id="elh_userlevelpermissions_permission" class="userlevelpermissions_permission">
