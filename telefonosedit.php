...
ftelefonosedit.Lists["x_id_persona"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombres","x_paterno","x_materno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
ftelefonosedit.Lists["x_id_persona"].Data = "<?php echo $telefonos_edit->id_persona->LookupFilterQuery(FALSE, "edit") ?>";
ftelefonosedit.Lists["x_tipo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftelefonosedit.Lists["x_tipo"].Options = <?php echo json_encode($telefonos_edit->tipo->Options()) ?>;
...
<input type="hidden" data-table="telefonos" data-field="x_Id" name="x_Id" id="x_Id" value="<?php echo ew_HtmlEncode($telefonos->Id->CurrentValue) ?>">
...
<?php if ($telefonos->id_persona->Visible) { // id_persona ?>
	<div id="r_id_persona" class="form-group">
		<label id="elh_telefonos_id_persona" for="x_id_persona" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->id_persona->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->id_persona->CellAttributes() ?>>
...
<?php if ($telefonos->tipo->Visible) { // tipo ?>
	<div id="r_tipo" class="form-group">
		<label id="elh_telefonos_tipo" for="x_tipo" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->tipo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->tipo->CellAttributes() ?>>
...
<?php if ($telefonos->numero->Visible) { // numero ?>
	<div id="r_numero" class="form-group">
		<label id="elh_telefonos_numero" for="x_numero" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->numero->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->numero->CellAttributes() ?>>
...
<?php if ($telefonos->ult_fecha_activo->Visible) { // ult_fecha_activo ?>
	<div id="r_ult_fecha_activo" class="form-group">
		<label id="elh_telefonos_ult_fecha_activo" for="x_ult_fecha_activo" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->ult_fecha_activo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->ult_fecha_activo->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("ftelefonosedit", "x_ult_fecha_activo", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
