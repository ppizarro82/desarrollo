...
$telefonos_edit = NULL; // Initialize page object first

class ctelefonos_edit extends ctelefonos {
	...
	// Page object name
	var $PageObjName = 'telefonos_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// telefono3
			$this->telefono3->SetDbValueDef($rsnew, $this->telefono3->CurrentValue, NULL, $this->telefono3->ReadOnly);

			// telefono4
			$this->telefono4->SetDbValueDef($rsnew, $this->telefono4->CurrentValue, NULL, $this->telefono4->ReadOnly);
...
// Create page object
if (!isset($telefonos_edit)) $telefonos_edit = new ctelefonos_edit();

// Page init
$telefonos_edit->Page_Init();

// Page main
$telefonos_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$telefonos_edit->Page_Render();
?>
...
var CurrentForm = ftelefonosedit = new ew_Form("ftelefonosedit", "edit");

// Validate form
ftelefonosedit.Validate = function() {
...
ftelefonosedit.Form_CustomValidate = 
...
ftelefonosedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
ftelefonosedit.MultiPage = new ew_MultiPage("ftelefonosedit");

// Dynamic selection lists
ftelefonosedit.Lists["x_id_fuente"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"fuentes"};
ftelefonosedit.Lists["x_id_fuente"].Data = "<?php echo $telefonos_edit->id_fuente->LookupFilterQuery(FALSE, "edit") ?>";
ftelefonosedit.Lists["x_id_gestion"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gestiones"};
ftelefonosedit.Lists["x_id_gestion"].Data = "<?php echo $telefonos_edit->id_gestion->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $telefonos_edit->ShowPageHeader(); ?>
<?php
$telefonos_edit->ShowMessage();
?>
<form name="ftelefonosedit" id="ftelefonosedit" class="<?php echo $telefonos_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($telefonos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $telefonos_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="telefonos">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($telefonos_edit->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="telefonos_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $telefonos_edit->MultiPages->NavStyle() ?>">
		<li<?php echo $telefonos_edit->MultiPages->TabStyle("1") ?>><a href="#tab_telefonos1" data-toggle="tab"><?php echo $telefonos->PageCaption(1) ?></a></li>
		<li<?php echo $telefonos_edit->MultiPages->TabStyle("2") ?>><a href="#tab_telefonos2" data-toggle="tab"><?php echo $telefonos->PageCaption(2) ?></a></li>
		<li<?php echo $telefonos_edit->MultiPages->TabStyle("3") ?>><a href="#tab_telefonos3" data-toggle="tab"><?php echo $telefonos->PageCaption(3) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $telefonos_edit->MultiPages->PageStyle("1") ?>" id="tab_telefonos1"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($telefonos->Id->Visible) { // Id ?>
	<div id="r_Id" class="form-group">
		<label id="elh_telefonos_Id" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->Id->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->Id->CellAttributes() ?>>
<span id="el_telefonos_Id">
<span<?php echo $telefonos->Id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $telefonos->Id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="telefonos" data-field="x_Id" data-page="1" name="x_Id" id="x_Id" value="<?php echo ew_HtmlEncode($telefonos->Id->CurrentValue) ?>">
<?php echo $telefonos->Id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($telefonos->id_fuente->Visible) { // id_fuente ?>
	<div id="r_id_fuente" class="form-group">
		<label id="elh_telefonos_id_fuente" for="x_id_fuente" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->id_fuente->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->id_fuente->CellAttributes() ?>>
...
<?php if ($telefonos->id_gestion->Visible) { // id_gestion ?>
	<div id="r_id_gestion" class="form-group">
		<label id="elh_telefonos_id_gestion" for="x_id_gestion" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->id_gestion->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->id_gestion->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $telefonos_edit->MultiPages->PageStyle("2") ?>" id="tab_telefonos2"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($telefonos->tipo_documento->Visible) { // tipo_documento ?>
	<div id="r_tipo_documento" class="form-group">
		<label id="elh_telefonos_tipo_documento" for="x_tipo_documento" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->tipo_documento->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->tipo_documento->CellAttributes() ?>>
...
<?php if ($telefonos->no_documento->Visible) { // no_documento ?>
	<div id="r_no_documento" class="form-group">
		<label id="elh_telefonos_no_documento" for="x_no_documento" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->no_documento->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->no_documento->CellAttributes() ?>>
...
<?php if ($telefonos->nombres->Visible) { // nombres ?>
	<div id="r_nombres" class="form-group">
		<label id="elh_telefonos_nombres" for="x_nombres" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->nombres->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->nombres->CellAttributes() ?>>
...
<?php if ($telefonos->paterno->Visible) { // paterno ?>
	<div id="r_paterno" class="form-group">
		<label id="elh_telefonos_paterno" for="x_paterno" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->paterno->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->paterno->CellAttributes() ?>>
...
<?php if ($telefonos->materno->Visible) { // materno ?>
	<div id="r_materno" class="form-group">
		<label id="elh_telefonos_materno" for="x_materno" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->materno->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->materno->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $telefonos_edit->MultiPages->PageStyle("3") ?>" id="tab_telefonos3"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($telefonos->telefono1->Visible) { // telefono1 ?>
	<div id="r_telefono1" class="form-group">
		<label id="elh_telefonos_telefono1" for="x_telefono1" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->telefono1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->telefono1->CellAttributes() ?>>
...
<?php if ($telefonos->telefono2->Visible) { // telefono2 ?>
	<div id="r_telefono2" class="form-group">
		<label id="elh_telefonos_telefono2" for="x_telefono2" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->telefono2->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->telefono2->CellAttributes() ?>>
...
<?php if ($telefonos->telefono3->Visible) { // telefono3 ?>
	<div id="r_telefono3" class="form-group">
		<label id="elh_telefonos_telefono3" for="x_telefono3" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->telefono3->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->telefono3->CellAttributes() ?>>
...
<?php if ($telefonos->telefono4->Visible) { // telefono4 ?>
	<div id="r_telefono4" class="form-group">
		<label id="elh_telefonos_telefono4" for="x_telefono4" class="<?php echo $telefonos_edit->LeftColumnClass ?>"><?php echo $telefonos->telefono4->FldCaption() ?></label>
		<div class="<?php echo $telefonos_edit->RightColumnClass ?>"><div<?php echo $telefonos->telefono4->CellAttributes() ?>>
...
<?php if (!$telefonos_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $telefonos_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $telefonos_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
