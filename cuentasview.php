...
$cuentas_view = NULL; // Initialize page object first

class ccuentas_view extends ccuentas {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Id"] <> "") {
				...
				$sReturnUrl = "cuentaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "cuentaslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "cuentaslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($cuentas_view)) $cuentas_view = new ccuentas_view();

// Page init
$cuentas_view->Page_Init();

// Page main
$cuentas_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cuentas_view->Page_Render();
?>
...
var CurrentForm = fcuentasview = new ew_Form("fcuentasview", "view");

// Form_CustomValidate event
fcuentasview.Form_CustomValidate = 
...
fcuentasview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcuentasview.Lists["x_estado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcuentasview.Lists["x_estado"].Options = <?php echo json_encode($cuentas_view->estado->Options()) ?>;
...
<?php if ($cuentas->Export == "") { ?>
<div class="ewToolbar">
<?php $cuentas_view->ExportOptions->Render("body") ?>
<?php
	foreach ($cuentas_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $cuentas_view->ShowPageHeader(); ?>
<?php
$cuentas_view->ShowMessage();
?>
<form name="fcuentasview" id="fcuentasview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cuentas_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cuentas_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cuentas">
<input type="hidden" name="modal" value="<?php echo intval($cuentas_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($cuentas->Id->Visible) { // Id ?>
	<tr id="r_Id">
		<td class="col-sm-2"><span id="elh_cuentas_Id"><?php echo $cuentas->Id->FldCaption() ?></span></td>
		<td data-name="Id"<?php echo $cuentas->Id->CellAttributes() ?>>
<span id="el_cuentas_Id">
<span<?php echo $cuentas->Id->ViewAttributes() ?>>
<?php echo $cuentas->Id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cuentas->codigo->Visible) { // codigo ?>
	<tr id="r_codigo">
		<td class="col-sm-2"><span id="elh_cuentas_codigo"><?php echo $cuentas->codigo->FldCaption() ?></span></td>
...
<?php echo $cuentas->codigo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cuentas->denominacion->Visible) { // denominacion ?>
	<tr id="r_denominacion">
		<td class="col-sm-2"><span id="elh_cuentas_denominacion"><?php echo $cuentas->denominacion->FldCaption() ?></span></td>
...
<?php echo $cuentas->denominacion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cuentas->inicio_contrato->Visible) { // inicio_contrato ?>
	<tr id="r_inicio_contrato">
		<td class="col-sm-2"><span id="elh_cuentas_inicio_contrato"><?php echo $cuentas->inicio_contrato->FldCaption() ?></span></td>
...
<?php echo $cuentas->inicio_contrato->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cuentas->fin_contrato->Visible) { // fin_contrato ?>
	<tr id="r_fin_contrato">
		<td class="col-sm-2"><span id="elh_cuentas_fin_contrato"><?php echo $cuentas->fin_contrato->FldCaption() ?></span></td>
...
<?php echo $cuentas->fin_contrato->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cuentas->fecha_registro->Visible) { // fecha_registro ?>
	<tr id="r_fecha_registro">
		<td class="col-sm-2"><span id="elh_cuentas_fecha_registro"><?php echo $cuentas->fecha_registro->FldCaption() ?></span></td>
...
<?php echo $cuentas->fecha_registro->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($cuentas->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td class="col-sm-2"><span id="elh_cuentas_estado"><?php echo $cuentas->estado->FldCaption() ?></span></td>
...
<?php echo $cuentas->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("deudas", explode(",", $cuentas->getCurrentDetailTable())) && $deudas->DetailView) {
?>
