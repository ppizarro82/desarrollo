...
class cdeudas_add extends cdeudas {
	...
	function AddRow($rsold = NULL) {
		...
		// mig_tipo_operacion
		$this->mig_tipo_operacion->SetDbValueDef($rsnew, $this->mig_tipo_operacion->CurrentValue, NULL, FALSE);

		// mig_fecha_desembolso
		$this->mig_fecha_desembolso->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->mig_fecha_desembolso->CurrentValue, 7), NULL, FALSE);

		// mig_fecha_estado
		$this->mig_fecha_estado->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->mig_fecha_estado->CurrentValue, 7), NULL, FALSE);

		// mig_anios_castigo
		$this->mig_anios_castigo->SetDbValueDef($rsnew, $this->mig_anios_castigo->CurrentValue, NULL, FALSE);

		// mig_tipo_garantia
		$this->mig_tipo_garantia->SetDbValueDef($rsnew, $this->mig_tipo_garantia->CurrentValue, NULL, FALSE);

		// mig_real
		$this->mig_real->SetDbValueDef($rsnew, $this->mig_real->CurrentValue, NULL, FALSE);

		// mig_actividad_economica
		$this->mig_actividad_economica->SetDbValueDef($rsnew, $this->mig_actividad_economica->CurrentValue, NULL, FALSE);

		// mig_agencia
		$this->mig_agencia->SetDbValueDef($rsnew, $this->mig_agencia->CurrentValue, NULL, FALSE);

		// mig_no_juicio
		$this->mig_no_juicio->SetDbValueDef($rsnew, $this->mig_no_juicio->CurrentValue, NULL, FALSE);

		// mig_nombre_abogado
		$this->mig_nombre_abogado->SetDbValueDef($rsnew, $this->mig_nombre_abogado->CurrentValue, NULL, FALSE);

		// mig_fase_procesal
		$this->mig_fase_procesal->SetDbValueDef($rsnew, $this->mig_fase_procesal->CurrentValue, NULL, FALSE);
		...
		// mig_total_cartera
		$this->mig_total_cartera->SetDbValueDef($rsnew, $this->mig_total_cartera->CurrentValue, NULL, FALSE);

		// mig_capital
		$this->mig_capital->SetDbValueDef($rsnew, $this->mig_capital->CurrentValue, NULL, FALSE);
...
// Multi-Page
fdeudasadd.MultiPage = new ew_MultiPage("fdeudasadd");
...
fdeudasadd.Lists["x_id_ciudad"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"ciudades"};
fdeudasadd.Lists["x_id_ciudad"].Data = "<?php echo $deudas_add->id_ciudad->LookupFilterQuery(FALSE, "add") ?>";
fdeudasadd.Lists["x_id_agente"] = {"LinkField":"x_id_user","Ajax":true,"AutoFill":false,"DisplayFields":["x_First_Name","x_Last_Name","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fdeudasadd.Lists["x_id_agente"].Data = "<?php echo $deudas_add->id_agente->LookupFilterQuery(FALSE, "add") ?>";
fdeudasadd.Lists["x_id_estadodeuda"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estado_deuda"};
fdeudasadd.Lists["x_id_estadodeuda"].Data = "<?php echo $deudas_add->id_estadodeuda->LookupFilterQuery(FALSE, "add") ?>";
fdeudasadd.Lists["x_mig_moneda"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdeudasadd.Lists["x_mig_moneda"].Options = <?php echo json_encode($deudas_add->mig_moneda->Options()) ?>;
...
<div class="nav-tabs-custom" id="deudas_add"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $deudas_add->MultiPages->NavStyle() ?>">
		<li<?php echo $deudas_add->MultiPages->TabStyle("1") ?>><a href="#tab_deudas1" data-toggle="tab"><?php echo $deudas->PageCaption(1) ?></a></li>
		<li<?php echo $deudas_add->MultiPages->TabStyle("2") ?>><a href="#tab_deudas2" data-toggle="tab"><?php echo $deudas->PageCaption(2) ?></a></li>
		<li<?php echo $deudas_add->MultiPages->TabStyle("3") ?>><a href="#tab_deudas3" data-toggle="tab"><?php echo $deudas->PageCaption(3) ?></a></li>
		<li<?php echo $deudas_add->MultiPages->TabStyle("4") ?>><a href="#tab_deudas4" data-toggle="tab"><?php echo $deudas->PageCaption(4) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $deudas_add->MultiPages->PageStyle("1") ?>" id="tab_deudas1"><!-- multi-page .tab-pane -->
...
<?php if ($deudas->id_ciudad->Visible) { // id_ciudad ?>
	<div id="r_id_ciudad" class="form-group">
		<label id="elh_deudas_id_ciudad" for="x_id_ciudad" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->id_ciudad->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->id_ciudad->CellAttributes() ?>>
...
<?php if ($deudas->id_agente->Visible) { // id_agente ?>
	<div id="r_id_agente" class="form-group">
		<label id="elh_deudas_id_agente" for="x_id_agente" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->id_agente->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->id_agente->CellAttributes() ?>>
...
<?php if ($deudas->id_estadodeuda->Visible) { // id_estadodeuda ?>
	<div id="r_id_estadodeuda" class="form-group">
		<label id="elh_deudas_id_estadodeuda" for="x_id_estadodeuda" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->id_estadodeuda->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->id_estadodeuda->CellAttributes() ?>>
...
<?php if ($deudas->mig_codigo_deuda->Visible) { // mig_codigo_deuda ?>
	<div id="r_mig_codigo_deuda" class="form-group">
		<label id="elh_deudas_mig_codigo_deuda" for="x_mig_codigo_deuda" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_codigo_deuda->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_codigo_deuda->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $deudas_add->MultiPages->PageStyle("2") ?>" id="tab_deudas2"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($deudas->mig_tipo_operacion->Visible) { // mig_tipo_operacion ?>
	<div id="r_mig_tipo_operacion" class="form-group">
		<label id="elh_deudas_mig_tipo_operacion" for="x_mig_tipo_operacion" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_tipo_operacion->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_tipo_operacion->CellAttributes() ?>>
...
<?php if ($deudas->mig_fecha_desembolso->Visible) { // mig_fecha_desembolso ?>
	<div id="r_mig_fecha_desembolso" class="form-group">
		<label id="elh_deudas_mig_fecha_desembolso" for="x_mig_fecha_desembolso" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_fecha_desembolso->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_fecha_desembolso->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fdeudasadd", "x_mig_fecha_desembolso", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($deudas->mig_fecha_estado->Visible) { // mig_fecha_estado ?>
	<div id="r_mig_fecha_estado" class="form-group">
		<label id="elh_deudas_mig_fecha_estado" for="x_mig_fecha_estado" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_fecha_estado->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_fecha_estado->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fdeudasadd", "x_mig_fecha_estado", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($deudas->mig_anios_castigo->Visible) { // mig_anios_castigo ?>
	<div id="r_mig_anios_castigo" class="form-group">
		<label id="elh_deudas_mig_anios_castigo" for="x_mig_anios_castigo" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_anios_castigo->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_anios_castigo->CellAttributes() ?>>
...
<?php if ($deudas->mig_tipo_garantia->Visible) { // mig_tipo_garantia ?>
	<div id="r_mig_tipo_garantia" class="form-group">
		<label id="elh_deudas_mig_tipo_garantia" for="x_mig_tipo_garantia" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_tipo_garantia->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_tipo_garantia->CellAttributes() ?>>
...
<?php if ($deudas->mig_real->Visible) { // mig_real ?>
	<div id="r_mig_real" class="form-group">
		<label id="elh_deudas_mig_real" for="x_mig_real" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_real->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_real->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $deudas_add->MultiPages->PageStyle("3") ?>" id="tab_deudas3"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($deudas->mig_actividad_economica->Visible) { // mig_actividad_economica ?>
	<div id="r_mig_actividad_economica" class="form-group">
		<label id="elh_deudas_mig_actividad_economica" for="x_mig_actividad_economica" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_actividad_economica->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_actividad_economica->CellAttributes() ?>>
...
<?php if ($deudas->mig_agencia->Visible) { // mig_agencia ?>
	<div id="r_mig_agencia" class="form-group">
		<label id="elh_deudas_mig_agencia" for="x_mig_agencia" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_agencia->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_agencia->CellAttributes() ?>>
...
<?php if ($deudas->mig_no_juicio->Visible) { // mig_no_juicio ?>
	<div id="r_mig_no_juicio" class="form-group">
		<label id="elh_deudas_mig_no_juicio" for="x_mig_no_juicio" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_no_juicio->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_no_juicio->CellAttributes() ?>>
...
<?php if ($deudas->mig_nombre_abogado->Visible) { // mig_nombre_abogado ?>
	<div id="r_mig_nombre_abogado" class="form-group">
		<label id="elh_deudas_mig_nombre_abogado" for="x_mig_nombre_abogado" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_nombre_abogado->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_nombre_abogado->CellAttributes() ?>>
...
<?php if ($deudas->mig_fase_procesal->Visible) { // mig_fase_procesal ?>
	<div id="r_mig_fase_procesal" class="form-group">
		<label id="elh_deudas_mig_fase_procesal" for="x_mig_fase_procesal" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_fase_procesal->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_fase_procesal->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $deudas_add->MultiPages->PageStyle("4") ?>" id="tab_deudas4"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($deudas->mig_moneda->Visible) { // mig_moneda ?>
	<div id="r_mig_moneda" class="form-group">
		<label id="elh_deudas_mig_moneda" for="x_mig_moneda" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_moneda->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_moneda->CellAttributes() ?>>
...
<?php if ($deudas->mig_tasa->Visible) { // mig_tasa ?>
	<div id="r_mig_tasa" class="form-group">
		<label id="elh_deudas_mig_tasa" for="x_mig_tasa" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_tasa->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_tasa->CellAttributes() ?>>
...
<?php if ($deudas->mig_plazo->Visible) { // mig_plazo ?>
	<div id="r_mig_plazo" class="form-group">
		<label id="elh_deudas_mig_plazo" for="x_mig_plazo" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_plazo->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_plazo->CellAttributes() ?>>
...
<?php if ($deudas->mig_dias_mora->Visible) { // mig_dias_mora ?>
	<div id="r_mig_dias_mora" class="form-group">
		<label id="elh_deudas_mig_dias_mora" for="x_mig_dias_mora" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_dias_mora->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_dias_mora->CellAttributes() ?>>
...
<?php if ($deudas->mig_monto_desembolso->Visible) { // mig_monto_desembolso ?>
	<div id="r_mig_monto_desembolso" class="form-group">
		<label id="elh_deudas_mig_monto_desembolso" for="x_mig_monto_desembolso" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_monto_desembolso->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_monto_desembolso->CellAttributes() ?>>
...
<?php if ($deudas->mig_total_cartera->Visible) { // mig_total_cartera ?>
	<div id="r_mig_total_cartera" class="form-group">
		<label id="elh_deudas_mig_total_cartera" for="x_mig_total_cartera" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_total_cartera->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_total_cartera->CellAttributes() ?>>
...
<?php if ($deudas->mig_capital->Visible) { // mig_capital ?>
	<div id="r_mig_capital" class="form-group">
		<label id="elh_deudas_mig_capital" for="x_mig_capital" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_capital->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_capital->CellAttributes() ?>>
...
<?php if ($deudas->mig_intereses->Visible) { // mig_intereses ?>
	<div id="r_mig_intereses" class="form-group">
		<label id="elh_deudas_mig_intereses" for="x_mig_intereses" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_intereses->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_intereses->CellAttributes() ?>>
...
<?php if ($deudas->mig_cargos_gastos->Visible) { // mig_cargos_gastos ?>
	<div id="r_mig_cargos_gastos" class="form-group">
		<label id="elh_deudas_mig_cargos_gastos" for="x_mig_cargos_gastos" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_cargos_gastos->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_cargos_gastos->CellAttributes() ?>>
...
<?php if ($deudas->mig_total_deuda->Visible) { // mig_total_deuda ?>
	<div id="r_mig_total_deuda" class="form-group">
		<label id="elh_deudas_mig_total_deuda" for="x_mig_total_deuda" class="<?php echo $deudas_add->LeftColumnClass ?>"><?php echo $deudas->mig_total_deuda->FldCaption() ?></label>
		<div class="<?php echo $deudas_add->RightColumnClass ?>"><div<?php echo $deudas->mig_total_deuda->CellAttributes() ?>>
