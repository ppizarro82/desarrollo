...
$telefonos_view = NULL; // Initialize page object first

class ctelefonos_view extends ctelefonos {
	...
	// Page object name
	var $PageObjName = 'telefonos_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Id"] <> "") {
				...
				$sReturnUrl = "telefonoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "telefonoslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "telefonoslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($telefonos_view)) $telefonos_view = new ctelefonos_view();

// Page init
$telefonos_view->Page_Init();

// Page main
$telefonos_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$telefonos_view->Page_Render();
?>
...
var CurrentForm = ftelefonosview = new ew_Form("ftelefonosview", "view");

// Form_CustomValidate event
ftelefonosview.Form_CustomValidate = 
...
ftelefonosview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
ftelefonosview.MultiPage = new ew_MultiPage("ftelefonosview");

// Dynamic selection lists
ftelefonosview.Lists["x_id_fuente"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"fuentes"};
ftelefonosview.Lists["x_id_fuente"].Data = "<?php echo $telefonos_view->id_fuente->LookupFilterQuery(FALSE, "view") ?>";
ftelefonosview.Lists["x_id_gestion"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gestiones"};
ftelefonosview.Lists["x_id_gestion"].Data = "<?php echo $telefonos_view->id_gestion->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($telefonos->Export == "") { ?>
<div class="ewToolbar">
<?php $telefonos_view->ExportOptions->Render("body") ?>
<?php
	foreach ($telefonos_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $telefonos_view->ShowPageHeader(); ?>
<?php
$telefonos_view->ShowMessage();
?>
<form name="ftelefonosview" id="ftelefonosview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($telefonos_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $telefonos_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="telefonos">
<input type="hidden" name="modal" value="<?php echo intval($telefonos_view->IsModal) ?>">
<?php if ($telefonos->Export == "") { ?>
<div class="ewMultiPage">
<div class="nav-tabs-custom" id="telefonos_view">
	<ul class="nav<?php echo $telefonos_view->MultiPages->NavStyle() ?>">
		<li<?php echo $telefonos_view->MultiPages->TabStyle("1") ?>><a href="#tab_telefonos1" data-toggle="tab"><?php echo $telefonos->PageCaption(1) ?></a></li>
		<li<?php echo $telefonos_view->MultiPages->TabStyle("2") ?>><a href="#tab_telefonos2" data-toggle="tab"><?php echo $telefonos->PageCaption(2) ?></a></li>
		<li<?php echo $telefonos_view->MultiPages->TabStyle("3") ?>><a href="#tab_telefonos3" data-toggle="tab"><?php echo $telefonos->PageCaption(3) ?></a></li>
	</ul>
	<div class="tab-content">
<?php } ?>
<?php if ($telefonos->Export == "") { ?>
		<div class="tab-pane<?php echo $telefonos_view->MultiPages->PageStyle("1") ?>" id="tab_telefonos1">
<?php } ?>
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($telefonos->Id->Visible) { // Id ?>
	<tr id="r_Id">
		<td class="col-sm-2"><span id="elh_telefonos_Id"><?php echo $telefonos->Id->FldCaption() ?></span></td>
		<td data-name="Id"<?php echo $telefonos->Id->CellAttributes() ?>>
<span id="el_telefonos_Id" data-page="1">
<span<?php echo $telefonos->Id->ViewAttributes() ?>>
<?php echo $telefonos->Id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->id_fuente->Visible) { // id_fuente ?>
	<tr id="r_id_fuente">
		<td class="col-sm-2"><span id="elh_telefonos_id_fuente"><?php echo $telefonos->id_fuente->FldCaption() ?></span></td>
		<td data-name="id_fuente"<?php echo $telefonos->id_fuente->CellAttributes() ?>>
<span id="el_telefonos_id_fuente" data-page="1">
<span<?php echo $telefonos->id_fuente->ViewAttributes() ?>>
<?php echo $telefonos->id_fuente->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->id_gestion->Visible) { // id_gestion ?>
	<tr id="r_id_gestion">
		<td class="col-sm-2"><span id="elh_telefonos_id_gestion"><?php echo $telefonos->id_gestion->FldCaption() ?></span></td>
		<td data-name="id_gestion"<?php echo $telefonos->id_gestion->CellAttributes() ?>>
<span id="el_telefonos_id_gestion" data-page="1">
<span<?php echo $telefonos->id_gestion->ViewAttributes() ?>>
<?php echo $telefonos->id_gestion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($telefonos->Export == "") { ?>
		<div class="tab-pane<?php echo $telefonos_view->MultiPages->PageStyle("2") ?>" id="tab_telefonos2">
<?php } ?>
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($telefonos->tipo_documento->Visible) { // tipo_documento ?>
	<tr id="r_tipo_documento">
		<td class="col-sm-2"><span id="elh_telefonos_tipo_documento"><?php echo $telefonos->tipo_documento->FldCaption() ?></span></td>
		<td data-name="tipo_documento"<?php echo $telefonos->tipo_documento->CellAttributes() ?>>
<span id="el_telefonos_tipo_documento" data-page="2">
<span<?php echo $telefonos->tipo_documento->ViewAttributes() ?>>
<?php echo $telefonos->tipo_documento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->no_documento->Visible) { // no_documento ?>
	<tr id="r_no_documento">
		<td class="col-sm-2"><span id="elh_telefonos_no_documento"><?php echo $telefonos->no_documento->FldCaption() ?></span></td>
		<td data-name="no_documento"<?php echo $telefonos->no_documento->CellAttributes() ?>>
<span id="el_telefonos_no_documento" data-page="2">
<span<?php echo $telefonos->no_documento->ViewAttributes() ?>>
<?php echo $telefonos->no_documento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->nombres->Visible) { // nombres ?>
	<tr id="r_nombres">
		<td class="col-sm-2"><span id="elh_telefonos_nombres"><?php echo $telefonos->nombres->FldCaption() ?></span></td>
		<td data-name="nombres"<?php echo $telefonos->nombres->CellAttributes() ?>>
<span id="el_telefonos_nombres" data-page="2">
<span<?php echo $telefonos->nombres->ViewAttributes() ?>>
<?php echo $telefonos->nombres->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->paterno->Visible) { // paterno ?>
	<tr id="r_paterno">
		<td class="col-sm-2"><span id="elh_telefonos_paterno"><?php echo $telefonos->paterno->FldCaption() ?></span></td>
		<td data-name="paterno"<?php echo $telefonos->paterno->CellAttributes() ?>>
<span id="el_telefonos_paterno" data-page="2">
<span<?php echo $telefonos->paterno->ViewAttributes() ?>>
<?php echo $telefonos->paterno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->materno->Visible) { // materno ?>
	<tr id="r_materno">
		<td class="col-sm-2"><span id="elh_telefonos_materno"><?php echo $telefonos->materno->FldCaption() ?></span></td>
		<td data-name="materno"<?php echo $telefonos->materno->CellAttributes() ?>>
<span id="el_telefonos_materno" data-page="2">
<span<?php echo $telefonos->materno->ViewAttributes() ?>>
<?php echo $telefonos->materno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($telefonos->Export == "") { ?>
		<div class="tab-pane<?php echo $telefonos_view->MultiPages->PageStyle("3") ?>" id="tab_telefonos3">
<?php } ?>
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($telefonos->telefono1->Visible) { // telefono1 ?>
	<tr id="r_telefono1">
		<td class="col-sm-2"><span id="elh_telefonos_telefono1"><?php echo $telefonos->telefono1->FldCaption() ?></span></td>
		<td data-name="telefono1"<?php echo $telefonos->telefono1->CellAttributes() ?>>
<span id="el_telefonos_telefono1" data-page="3">
<span<?php echo $telefonos->telefono1->ViewAttributes() ?>>
<?php echo $telefonos->telefono1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->telefono2->Visible) { // telefono2 ?>
	<tr id="r_telefono2">
		<td class="col-sm-2"><span id="elh_telefonos_telefono2"><?php echo $telefonos->telefono2->FldCaption() ?></span></td>
		<td data-name="telefono2"<?php echo $telefonos->telefono2->CellAttributes() ?>>
<span id="el_telefonos_telefono2" data-page="3">
<span<?php echo $telefonos->telefono2->ViewAttributes() ?>>
<?php echo $telefonos->telefono2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->telefono3->Visible) { // telefono3 ?>
	<tr id="r_telefono3">
		<td class="col-sm-2"><span id="elh_telefonos_telefono3"><?php echo $telefonos->telefono3->FldCaption() ?></span></td>
		<td data-name="telefono3"<?php echo $telefonos->telefono3->CellAttributes() ?>>
<span id="el_telefonos_telefono3" data-page="3">
<span<?php echo $telefonos->telefono3->ViewAttributes() ?>>
<?php echo $telefonos->telefono3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->telefono4->Visible) { // telefono4 ?>
	<tr id="r_telefono4">
		<td class="col-sm-2"><span id="elh_telefonos_telefono4"><?php echo $telefonos->telefono4->FldCaption() ?></span></td>
		<td data-name="telefono4"<?php echo $telefonos->telefono4->CellAttributes() ?>>
<span id="el_telefonos_telefono4" data-page="3">
<span<?php echo $telefonos->telefono4->ViewAttributes() ?>>
<?php echo $telefonos->telefono4->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
