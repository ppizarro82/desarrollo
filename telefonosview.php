...
ftelefonosview.Lists["x_id_persona"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombres","x_paterno","x_materno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
ftelefonosview.Lists["x_id_persona"].Data = "<?php echo $telefonos_view->id_persona->LookupFilterQuery(FALSE, "view") ?>";
ftelefonosview.Lists["x_tipo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftelefonosview.Lists["x_tipo"].Options = <?php echo json_encode($telefonos_view->tipo->Options()) ?>;
...
<?php if ($telefonos->id_persona->Visible) { // id_persona ?>
	<tr id="r_id_persona">
		<td class="col-sm-2"><span id="elh_telefonos_id_persona"><?php echo $telefonos->id_persona->FldCaption() ?></span></td>
...
<a<?php echo $telefonos->id_persona->LinkAttributes() ?>><?php echo $telefonos->id_persona->ViewValue ?></a>
<?php } else { ?>
<?php echo $telefonos->id_persona->ViewValue ?>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($telefonos->tipo->Visible) { // tipo ?>
	<tr id="r_tipo">
		<td class="col-sm-2"><span id="elh_telefonos_tipo"><?php echo $telefonos->tipo->FldCaption() ?></span></td>
...
<?php echo $telefonos->tipo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->numero->Visible) { // numero ?>
	<tr id="r_numero">
		<td class="col-sm-2"><span id="elh_telefonos_numero"><?php echo $telefonos->numero->FldCaption() ?></span></td>
...
<?php echo $telefonos->numero->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($telefonos->ult_fecha_activo->Visible) { // ult_fecha_activo ?>
	<tr id="r_ult_fecha_activo">
		<td class="col-sm-2"><span id="elh_telefonos_ult_fecha_activo"><?php echo $telefonos->ult_fecha_activo->FldCaption() ?></span></td>
...
<?php echo $telefonos->ult_fecha_activo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
