...
class caudittrail_add extends caudittrail {
	...
	function NewRow() {
		...
		$row['table'] = $this->table->CurrentValue;
...
faudittrailadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($audittrail_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($audittrail->datetime->Visible) { // datetime ?>
	<div id="r_datetime" class="form-group">
		<label id="elh_audittrail_datetime" for="x_datetime" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->datetime->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($audittrail->script->Visible) { // script ?>
	<div id="r_script" class="form-group">
		<label id="elh_audittrail_script" for="x_script" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->script->FldCaption() ?></label>
...
<?php if ($audittrail->user->Visible) { // user ?>
	<div id="r_user" class="form-group">
		<label id="elh_audittrail_user" for="x_user" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->user->FldCaption() ?></label>
...
<?php if ($audittrail->action->Visible) { // action ?>
	<div id="r_action" class="form-group">
		<label id="elh_audittrail_action" for="x_action" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->action->FldCaption() ?></label>
		<div class="<?php echo $audittrail_add->RightColumnClass ?>"><div<?php echo $audittrail->action->CellAttributes() ?>>
...
<?php if ($audittrail->table->Visible) { // table ?>
	<div id="r_table" class="form-group">
		<label id="elh_audittrail_table" for="x_table" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->table->FldCaption() ?></label>
		<div class="<?php echo $audittrail_add->RightColumnClass ?>"><div<?php echo $audittrail->table->CellAttributes() ?>>
...
<?php if ($audittrail->field->Visible) { // field ?>
	<div id="r_field" class="form-group">
		<label id="elh_audittrail_field" for="x_field" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->field->FldCaption() ?></label>
...
<?php if ($audittrail->keyvalue->Visible) { // keyvalue ?>
	<div id="r_keyvalue" class="form-group">
		<label id="elh_audittrail_keyvalue" for="x_keyvalue" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->keyvalue->FldCaption() ?></label>
...
<?php if ($audittrail->oldvalue->Visible) { // oldvalue ?>
	<div id="r_oldvalue" class="form-group">
		<label id="elh_audittrail_oldvalue" for="x_oldvalue" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->oldvalue->FldCaption() ?></label>
...
<?php if ($audittrail->newvalue->Visible) { // newvalue ?>
	<div id="r_newvalue" class="form-group">
		<label id="elh_audittrail_newvalue" for="x_newvalue" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->newvalue->FldCaption() ?></label>
