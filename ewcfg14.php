...
define("EW_PROJECT_NAME", "cobproject", TRUE); // Project name
...
define("EW_PDF_MEMORY_LIMIT", "512M", TRUE); // Memory limit
define("EW_PDF_TIME_LIMIT", 360, TRUE); // Time limit
?>
