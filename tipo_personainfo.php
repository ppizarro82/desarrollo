...
//
// Table class for tipo_persona
//
class ctipo_persona extends cTable {
	var $Id;
	var $nombre;
	var $estado;
	...
	function __construct() {
		...
		$this->TableVar = 'tipo_persona';
		$this->TableName = 'tipo_persona';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tipo_persona`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Id
		$this->Id = new cField('tipo_persona', 'tipo_persona', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->Id->Sortable = TRUE; // Allow sort
		$this->Id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id'] = &$this->Id;

		// nombre
		$this->nombre = new cField('tipo_persona', 'tipo_persona', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, -1, FALSE, '`nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombre->Sortable = TRUE; // Allow sort
		$this->fields['nombre'] = &$this->nombre;

		// estado
		$this->estado = new cField('tipo_persona', 'tipo_persona', 'x_estado', 'estado', '`estado`', '`estado`', 16, -1, FALSE, '`estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tipo_persona`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "tipo_personaedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "tipo_personaadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tipo_personaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tipo_personaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "tipo_personaadd.php?" . $this->UrlParm($parm);
		else
			$url = "tipo_personaadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tipo_personadelete.php", $this->UrlParm());
	}
