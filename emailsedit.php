...
$emails_edit = NULL; // Initialize page object first

class cemails_edit extends cemails {
...
// Create page object
if (!isset($emails_edit)) $emails_edit = new cemails_edit();

// Page init
$emails_edit->Page_Init();

// Page main
$emails_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$emails_edit->Page_Render();
?>
...
var CurrentForm = femailsedit = new ew_Form("femailsedit", "edit");

// Validate form
femailsedit.Validate = function() {
...
femailsedit.Form_CustomValidate = 
...
<?php $emails_edit->ShowPageHeader(); ?>
<?php
$emails_edit->ShowMessage();
?>
<form name="femailsedit" id="femailsedit" class="<?php echo $emails_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($emails_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $emails_edit->Token ?>">
<?php } ?>
...
<?php if ($emails->Id->Visible) { // Id ?>
	<div id="r_Id" class="form-group">
		<label id="elh_emails_Id" class="<?php echo $emails_edit->LeftColumnClass ?>"><?php echo $emails->Id->FldCaption() ?></label>
		<div class="<?php echo $emails_edit->RightColumnClass ?>"><div<?php echo $emails->Id->CellAttributes() ?>>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $emails_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
