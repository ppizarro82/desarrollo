...
femailsadd.Lists["x_id_persona"] = {"LinkField":"x_Id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombres","x_paterno","x_materno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"personas"};
femailsadd.Lists["x_id_persona"].Data = "<?php echo $emails_add->id_persona->LookupFilterQuery(FALSE, "add") ?>";
...
<?php if ($emails->id_persona->Visible) { // id_persona ?>
	<div id="r_id_persona" class="form-group">
		<label id="elh_emails_id_persona" for="x_id_persona" class="<?php echo $emails_add->LeftColumnClass ?>"><?php echo $emails->id_persona->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emails_add->RightColumnClass ?>"><div<?php echo $emails->id_persona->CellAttributes() ?>>
...
<?php if ($emails->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_emails__email" for="x__email" class="<?php echo $emails_add->LeftColumnClass ?>"><?php echo $emails->_email->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emails_add->RightColumnClass ?>"><div<?php echo $emails->_email->CellAttributes() ?>>
